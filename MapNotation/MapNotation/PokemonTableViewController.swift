...
class PokemonTableViewControler: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.pokeImage.image = UIImage(named: self.pokemons[indexPath.row])
        cell.pokeName.text = self.pokemons[indexPath.row].capitalized
        return cell
    }
